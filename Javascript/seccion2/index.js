...
function funcion_sumar(array, contador = 0, sumatoria = 0) {
  if(contador < array.length){
    sumatoria += array[contador];
    contador++;
    console.log(sumatoria);
    funcion_sumar(array, contador, sumatoria);
    }
}
...
function funcion_mayor(array, contador = 0, mayor = 0) {

  if(contador < array.length){
      if (array[contador] > array[contador++]) {
          console.log();
      }
      contador++;
      funcion_mayor(array, contador, mayor);
  }
}
